...
export default function OKRsPage() {
  ...
  // Simular llamada a API para cargar datos
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Simular error ocasional (descomentar para probar)
        // if (Math.random() > 0.8) {
        //   throw new Error('Error de conexión con el servidor')
        // }
        
        // Por ahora, usar datos mock del JSON actualizado
        const mockOkrs: OKR[] = [
          {
            id: "okr_001",
            projectId: "b3bc",
        ...
        const mockUsers: User[] = [
          { id: "1", name: "Admin User", avatar: "https://i.ibb.co/6R40x6rf/1aa39c2f0743.jpg" },
          { id: "2", name: "Product Owner", avatar: "https://i.ibb.co/jCXzjH8/d55e8ff23d62.gif" },
          { id: "3", name: "Developer User", avatar: "/placeholder.svg?height=40&width=40" }
        ]
